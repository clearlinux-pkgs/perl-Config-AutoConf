...
%prep
%setup -q -n Config-AutoConf-0.318
cd %{_builddir}/Config-AutoConf-0.318
...
cp %{_builddir}/Config-AutoConf-0.318/LICENSE %{buildroot}/usr/share/package-licenses/perl-Config-AutoConf/27a14e34d2e75b1794c713418c26874bfc78d4c5
if test -f Makefile.PL; then
